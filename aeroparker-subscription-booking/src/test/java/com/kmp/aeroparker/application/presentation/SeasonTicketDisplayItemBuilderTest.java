...
class SeasonTicketDisplayItemBuilderTest
{
	@Mock
	...
	@InjectMocks
	private SeasonTicketDisplayItemBuilder builder;
	@Mock
	...
	void testBuild()
	{
		...
		assertThat(builder.build(availabilityDetails)).isNotNull()
				.hasFieldOrPropertyWithValue("endDate", DateUtil.nowLocalDate("Europe/London")
						.plusMonths(1));
	}
